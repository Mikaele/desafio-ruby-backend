...
class ArchivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archive" do
    assert_difference('Archive.count') do
      post archives_url, params: { archive: { attachment: @archive.attachment, checkhsum: @archive.checkhsum, lines: @archive.lines } }
    end
  ...
  test "should update archive" do
    patch archive_url(@archive), params: { archive: { attachment: @archive.attachment, checkhsum: @archive.checkhsum, lines: @archive.lines } }
